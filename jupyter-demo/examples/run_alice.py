...
def main():
    ...
    parser.add_argument("--config", type=str, required=True, help="Path to YAML config (alice)")
    args = parser.parse_args()

    cfg = load_config(args.config)
    assert cfg.role == "alice", "This runner is for Alice; set role: alice in config."
